...
(function($){
	...
	_consts = {
		...
		folder: {
			// 折叠icon
			OPEN: "open iconfont icon-folder", // 打开文件图标
			CLOSE: "close iconfont icon-folder",   // 折叠文件图标
	...
	view = {
		...
		makeNodeIcoClass: function(setting, node) {
			...
			if (!node.isAjaxing) {
				...
				if (node.isParent) {
					...
					// 子节点图标
					icoCss = [setting.usericon.CHILDRENNODE+" "+"a"];
		...
		makeNodeLineClass: function(setting, node) {
			...
			if (node.isParent) {
				...
				lineClass.push(node.open ? consts.folder.OPENDK : consts.folder.CLOSEZD); // 初始化折叠icon
	...
	$.fn.zTree = {
		...
		init: function(obj, zSetting, zNodes) {
			...
			// todo 初始化的时候改变图标
			$.extend(true, this.consts.folder, zSetting.usericon);
